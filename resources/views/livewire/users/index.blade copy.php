...
<script type="module">
  ...
  createApp({
    setup() {
        ...
        const listRole = ref([{ 'id': 2, 'name':'guru'}, { 'id': 3, 'name':'siswa'}, { 'id': 4, 'name':'orang-tua'}])
        let dataUser = @json($listUser)
        ...
        function storeDataUserGeneral() {
            // const hasEmptyField = Object.values(dataUserGeneral.value).some(value => value == '');

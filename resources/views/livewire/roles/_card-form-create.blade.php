<div class="relative p-4 w-full max-w-2xl max-h-full">
    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-300">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
            <h3 class="text-xl font-semibold text-gray-900 dark:text-gray-800 dark:semibold">
                Create New Role
            </h3>
        </div>
        <!-- Modal body -->
        <div class="p-4 md:p-5 space-y-4">
            ...
            <div class="col-span-2 sm:col-span-1">
                <label for="role_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-800">Jabatan / Role</label>
            ...
            <div>
                <label for="name" class="block dark:text-gray-800 mb-2 text-sm font-medium text-gray-900">Jabatan Tambahan</label>

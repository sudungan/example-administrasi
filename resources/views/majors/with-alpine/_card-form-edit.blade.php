            ...
            <form @submit.prevent="updateMajor" class="space-y-4">
                <div class="grid gap-2 mb-4 grid-cols-1">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select x-model="major.user_id" @change="changeDataMajor($event)" id="user_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500">

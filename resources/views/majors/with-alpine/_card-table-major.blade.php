                ...
                <tbody>
                    <template x-for="(major, index) in listMajor" :key="index">
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-2 py-4">
                                <template x-if="major.head_major && major.head_major.id">
                                    <span  x-text="major.head_major.name" class="bg-green-100 text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-sm dark:bg-gray-700 dark:text-green-400 border border-green-400">
                                    </span>
                                </template>
                            </tid>
                             <th scope="row"

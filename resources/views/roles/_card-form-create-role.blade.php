<div class="relative p-4 w-full max-w-2xl max-h-full">
    <div class="relative bg-gray-300 rounded-lg shadow-sm dark:bg-gray-900">
        ...
        <div class="p-4 md:p-5 space-y-4">
            <form @submit.prevent="storeAdditionRole" class="space-y-4">
                <div class="grid gap-2 mb-4 grid-cols-1">
                    <div class="col-span-2 sm:col-span-1">
                        <label for="roleId" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jabatan Tambahan/ addition Role</label>
                        <select x-model="additionRole.roleId" id="roleId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option value="">Select role</option>
                            <template x-for="role in listRole" :key="role.id">
                                <option :value="role.id" x-text="role.name"></option>
                            </template>
                        </select>
                        <template x-if="errors.roleId">
                            <p x-text="errors.roleId" class="mt-1 text-sm text-red-600 dark:text-red-500"></p>
                        </template>
                    </div>
                    <div class="col-span-2 sm:col-span-1">

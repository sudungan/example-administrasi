        ...
        <div class="relative p-4 w-full max-w-3xl max-h-full">
            <div class="relative bg-gray-300 rounded-lg shadow-sm dark:bg-gray-900">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form @submit.prevent="updateUser(editUser.id)" id="formUpdateUser" class="space-y-4">
                        <div class="grid gap-2 mb-4 grid-cols-2">
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <input-password v-model="editUser.password" :error="errors.password" />
                            </div>
                            ...
                            <div class="col-span-2 sm:col-span-1">
                                ...
                                <select v-model="editUser.role_id" id="role_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:gray-600 dark:focus:ring-primary-500 dark:focus:border-primary-500">

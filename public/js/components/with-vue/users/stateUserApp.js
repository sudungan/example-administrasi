...
export default function stateUserApp () {
    createApp({
        components: { pagination, formUserDetail, inputPassword, formEditUser, loadingTableUser
        },
        setup() {
            const users = ref([]);
            const search = ref("")
        ...
        template: `
            <div class="relative h-full flex-1 overflow-hidden rounded-xl">
                ...
                <!-- komponent untuk loading-data-table-user -->
                <div
                ...
                <!-- komponent untuk data-table-user -->
                 <div
                    v-show="currentView === 'table'"
                    class="relative shadow-md sm:rounded-lg">
                ...
                <div v-cloak v-show="currentView === 'show-list-subject-by'" class="relative sm:rounded-lg">

                </div>

                 <!-- komponent untuk form-user-detail -->
                <div v-cloak v-show="currentView === 'create-user-detail'"
                ...
                <!-- komponent untuk form-edit-user -->
                <div v-cloak v-show="currentView === 'edit'" class="flex fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                    <form-edit-user

...
export default defineComponent({
    name: 'dataTableUser', // nama child component
    props: {
                        ...
                        <tr v-for="(user, index) in users" :key="user.id"  class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <td class="px-6 py-4 flex gap-3">
                                    ...
                                    <a v-on:click="btnEditUser(user.id)" data-tooltip-target="tooltip-edit" class="cursor-pointer font-medium text-gray-600 dark:text-gray-500 hover:underline">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">

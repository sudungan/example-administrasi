...
export default defineComponent({
    ...
    setup(props, {emit}) {
        ...
        // melakukan clone data ke childExam
        const chiidExam = ref({...props.exam}) 

        const editExam = reactive({ name: '', description: '', period: new Date().getFullYear() }) 
        ...
        // melihat perubahan langsung dari props.exam yang dikirim dari parent disimpan ke state childStudents
        watch(() => props.exam, (newVal) => { Object.assign(editExam, newVal)  }, { immediate: true });
        ...
        return {
            vocationalExam, updateExam, errors, closeCreateForm, waitingProcess: childIsLoading,
            fieldLabels, resetFormCreate, exam: chiidExam, editExam
        }
    },
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-gray-300 rounded-lg shadow-sm dark:bg-gray-900">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form @submit.prevent="updateExam(editExam.id)" class="space-y-4">

                    ...
                    <form @submit.prevent="storeSubject" class="space-y-4">
                        ...
                        <div class="mb-2 w-full inline space-x-4 space-x-reverse">
                            <table class="w-full text-sm rounded text-left text-gray-400 dark:text-gray-400">
                                ...
                                <tbody :class="{ 'divide-y divide-gray-200 dark:divide-gray-700 mb-2': subjectClassroom.classrooms_subject.length > 1 }">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-1 py-1 align-top">
                                                <div class="flex justify-center space-x-1">
                                                    <button
                                                        type="button"
                                                        v-if="index === subjectClassroom.classrooms_subject.length - 1 && isAllFilled"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="red"
                                                            ...
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107
                                                                    1.022.166m-1.022-.165L18.16 19.673a2.25 2.25
                                                                    0 0 1-2.244 2.077H8.084a2.25 2.25

...
export default defineComponent({
    ...
    setup(props, {emit}) {
        ...
        function editSubjectTeacher(subjectId) {
            // emit kasi tau parent mau ambil subject id untuk dilakkan edit mata pelajaran
        ...
        return {
            localListSubject, getBadgeClass, addSubjectTeacher, deleteConfirmation, editSubjectTeacher,
                                    ...
                                    <div v-for="subject in teacher.subjects" :key="subject.id" class="inline-flex">
                                        <template  v-for="classroom in subject.classroom_subject" :key="classroom.id">
                                            <span
                                                ...
                                                <svg @click="editSubjectTeacher(subject.id)"
                                                     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="gray" class="cursor-pointer size-3">

                                    ...
                                    <div v-for="subject in teacher.subjects" :key="subject.id" class="inline-flex">
                                        <template  v-for="classroom in subject.classroom_subject" :key="classroom.id">
                                            <span
                                                ...
                                                >
                                                {{ subject.name }} {{ classroom.name }} {{ classroom.major?.initial }}
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red" class="cursor-pointer size-3">

...
export default function stateClassroom() {
    createApp({
        ...
        <div class="flex gap-4">
            ...
            <div
                v-show="listClassroom.length == 0 && currentView == 'table'" class="flex items-center p-2 mb-2 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-100 w-full" role="alert">
